...
$DOCKER_CRE build --platform=linux/amd64 --network=host --build-arg=TARGETARCH=amd64 --build-arg=DPSERVICE_FEATURES="-Denable_virtual_services=true -Denable_pf1_proxy=true" -t "$TAG" .
